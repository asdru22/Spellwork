...
execute as @p[gamemode=!creative,advancements={epl:technical/player/interact_with_villager=true}] run function epl:block/spellbinding_station/interact/add_lapis/iterate
