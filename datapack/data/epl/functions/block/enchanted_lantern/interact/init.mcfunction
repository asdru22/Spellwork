...
execute positioned ~ ~1 ~ as @e[type=armor_stand,distance=..0.1,limit=1,tag=epl.block.enchanted_lantern.display] run function epl:block/enchanted_lantern/interact/display/as_stand