data modify storage epl:storage root.temp.display set value {}
...
execute if data storage epl:storage root.temp.data.Item.tag.epl{id:"rekindling_feather"} run data modify storage epl:storage root.temp.display.Ingredient set value '{"text":"\\uc003"}'